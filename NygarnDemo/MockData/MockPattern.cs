...
{
    //private static readonly decimal JUNIOR;
    //private static List<Pattern> _patterns = new List<Pattern>()
    //{
    //    new Pattern("Mette Wendelboe Okkels", "DiffLevel5of5", Category.Cardigan, Fits.Kvinde, 50, "ESTHER JACKET", 
    //        "Esther Jacket strikkes oppefra og ned med strukturstrik.", "PetitKnit", 1),
    //    new Pattern("Mette Wendelboe Okkels", "DiffLevel3of5", Category.Sweater, Fits.Barn, 45, "CLOUD SWEATER JUNIOR",
