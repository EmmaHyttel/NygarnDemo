...
public class MockKnittingNeedle
{
    ...
    {
        new KnittingNeedle(NeedleAndHookMaterial.plastik, Size.Size30mm, NeedleType.Rundpinde, "Knitpro", "Gode til alt", Brand.Hobbii, 2, 149, true), 
        new KnittingNeedle(NeedleAndHookMaterial.bambus, Size.Size40mm, NeedleType.Jumperpinde, "Hot", "Dejlig store", Brand.PetitKnit, 2, 499, true),
